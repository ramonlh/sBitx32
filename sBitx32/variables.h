...
#define WEBPort  8088 
  ...
  typedef struct {    // datos configuración
      ...
      unsigned long LIBRE01;    // NO USADA, ver variable fuera de la estructura
      uint8_t ritOn;
      ...
      unsigned long gen0=11056000;
      unsigned long gen1=56061000;
      unsigned long gen2=55005000;
      int16_t posATUC1;
      int16_t posATUC2;
      int ifShiftValue;   //
      uint8_t addrADS1115B; // dir ADS 1115 module analog converter
      int16_t attLevel;     // ATT : RF Gain Control (Receive) <-- IF1 Shift, 0 : Off, ShiftValue is attLevel * 100; attLevel 150 = 15K
      uint8_t LIBRE2[4];
      int squelchval;
      int ATUIter;
      uint8_t LIBRE1[2];
      ...
      uint8_t dweetenable;
      char dweetuser[10];         // 10 bytes, dtweet account user ID
      char dweetkey[15];          // 15 bytes, dtweet account key
      uint8_t mqttenabled;
      ...
      int wsPort;
      int udpPortFreq;
      unsigned long fc1=44998325;   // frecuencia central filtro 1
      unsigned long fc2=11057415;   // frecuencia central filtro 2
      unsigned int df1=16695;       // ancho de banda filtro 1
      unsigned int df2=2570;        // ancho de banda filtro 2
      unsigned int audiolower=300;    // límite inferior banda ssb
...
void initConf()
{
  ...
  conf.connMode=1;     // 0: IP,  1: Serial2
  ...
  conf.dweetenable=1;
  strcpy(conf.dweetuser,"");         // 10 bytes, dtweet account user ID
  strcpy(conf.dweetkey,"");          // 15 bytes, dtweet account key
  conf.mqttenabled=0;
  ...
  conf.fc1=44998325;   // frecuencia central filtro 1
  conf.fc2=11057415;   // frecuencia central filtro 2
  conf.df1=16695;       // ancho de banda filtro 1
